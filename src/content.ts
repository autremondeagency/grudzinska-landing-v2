...
export const HOW = {
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        "Prowadz\u0119 Ci\u0119 przez ca\u0142y proces. Regularne konsultacje, dostosowywanie planu, wsparcie psychodietetyczne.",
    },
  ],
};
...
export const CONTACT_SECTION = {
  ...
  description:
    "Pierwszy krok jest najtrudniejszy. Ale nie musisz go robi\u0107 sama. Napisz lub zadzwo\u0144 \u2014 porozmawiamy.",
  ...
  privacyNote:
    "Twoje dane s\u0105 bezpieczne. Kontaktuj\u0119 si\u0119 wy\u0142\u0105cznie w sprawie konsultacji.",
...
export const TESTIMONIALS = {
  label: "Opinie pacjentek",
  heading: "Nie musisz mi wierzy\u0107 na s\u0142owo",
  subheading: "Pos\u0142uchaj, co m\u00f3wi\u0105 kobiety, kt\u00f3re ju\u017c t\u0119 drog\u0119 przesz\u0142y.",
  reviews: [
    {
      name: "Marta",
      age: 38,
      text: "Przysz\u0142am do Ani trzy miesi\u0105ce przed sleeve. By\u0142am przera\u017cona \u2014 chirurg powiedzia\u0142 mi \u201eprosz\u0119 schudn\u0105\u0107\u201d i tyle. \u017badnych wskaz\u00f3wek, \u017cadnego planu. Ania usiad\u0142a ze mn\u0105, rozpisa\u0142a wszystko krok po kroku i pierwszy raz poczu\u0142am, \u017ce kto\u015b naprawd\u0119 rozumie, przez co przechodz\u0119. Schud\u0142am te 10% i wesz\u0142am na sal\u0119 spokojna.",
      metric: "-10%",
    },
    {
      name: "Kasia",
      age: 45,
      text: "Najwi\u0119ksza zmiana? Przesta\u0142am je\u015b\u0107 na nerwy. Serio. Ca\u0142e \u017cycie my\u015bla\u0142am, \u017ce jestem s\u0142aba, \u017ce nie mam silnej woli. Ania mi wyt\u0142umaczy\u0142a, \u017ce to nie kwestia woli \u2014 to mechanizm w g\u0142owie. Po p\u00f3\u0142 roku pracy z ni\u0105 schud\u0142am 14 kilo jeszcze przed operacj\u0105. Ale wa\u017cniejsze jest to, \u017ce w ko\u0144cu rozumiem, dlaczego jem.",
      metric: "-14 kg",
    },
    {
      name: "Agnieszka",
      age: 52,
      text: "Jestem 8 miesi\u0119cy po bypasie. Bez Ani pewnie by\u0142abym w tej statystyce os\u00f3b, kt\u00f3re tyj\u0105 z powrotem. Bo operacja to dopiero pocz\u0105tek \u2014 najtrudniejsze jest potem. Ania mi pomog\u0142a przej\u015b\u0107 przez diet\u0119 p\u0142ynn\u0105, przez kryzysy, przez momenty kiedy chcia\u0142am rzuci\u0107 to wszystko. Nie zostawi\u0142a mnie w po\u0142owie drogi. Dos\u0142ownie.",
      metric: "8 mies.",
    },
    {
      name: "Justyna",
      age: 41,
      text: "Ba\u0142am si\u0119, \u017ce dietetyczka b\u0119dzie mnie ocenia\u0107. \u017be us\u0142ysz\u0119 \u201eno to trzeba by\u0142o mniej je\u015b\u0107\u201d. Nic takiego. Ania na pierwszej rozmowie powiedzia\u0142a: \u201eopowiedz mi swoj\u0105 histori\u0119\u201d. I naprawd\u0119 s\u0142ucha\u0142a. To by\u0142 pierwszy raz, kiedy kto\u015b z bran\u017cy medycznej potraktowa\u0142 mnie jak cz\u0142owieka, a nie jak problem do rozwi\u0105zania.",
      metric: "1. wizyta",
    },
  ],
};
  ...
  items: [
    {
      ...
      answer: "Pierwsza rozmowa jest ca\u0142kowicie darmowa \u2014 15-20 minut, \u017ceby\u015bmy mog\u0142y si\u0119 pozna\u0107 i zobaczy\u0107, czy mog\u0119 Ci pom\u00f3c. Dalsz\u0105 wsp\u00f3\u0142prac\u0119 i pakiety opieki omawiam indywidualnie, bo ka\u017cda sytuacja jest inna. Nie ma jednego cennika, kt\u00f3ry pasowa\u0142by do wszystkich.",
    },
    {
    ...
    },
    {
      ...
      answer: "Tak, i uwa\u017cam, \u017ce to kluczowy etap. Pierwsze miesi\u0105ce po zabiegu to dieta p\u0142ynna, papkowata, potem stopniowe rozszerzanie. Cia\u0142o zmienia si\u0119 szybciej ni\u017c g\u0142owa. Wspieram Ci\u0119 dietetycznie i psychologicznie \u2014 \u017ceby\u015b nie zosta\u0142a sama z \u017co\u0142\u0105dkiem wielko\u015bci jajka i zerow\u0105 instrukcj\u0105 obs\u0142ugi.",
    },
    {
    ...
    },
    {
      ...
      answer: "W og\u00f3le nie. Pracuj\u0119 z pacjentkami z ca\u0142ej Polski i nie tylko. Wszystko odbywa si\u0119 online \u2014 konsultacje, jad\u0142ospisy, wsparcie mi\u0119dzy spotkaniami. Odleg\u0142o\u015b\u0107 nie jest przeszkod\u0105.",
    },
  ],
};
...
export const STATS = {
  items: [
    { value: "200+", label: "pacjentek" },
    { value: "5 lat", label: "do\u015bwiadczenia" },
    { value: "95%", label: "skuteczno\u015b\u0107" },
    { value: "35 kg", label: "\u015brednio utracone" },
  ],
};
